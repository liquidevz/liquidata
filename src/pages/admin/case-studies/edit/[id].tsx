...
export default function EditCaseStudy() {
  ...
  const fetchCaseStudy = async () => {
    try {
      const response = await adminFetch(`/api/admin/case-studies/${id}`);
      setFormData({
  ...
  return (
    <>
      <Head>
        <title>Edit Case Study - Admin Dashboard</title>
      </Head>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">Update portfolio case study</p>
              </div>
            </div>
