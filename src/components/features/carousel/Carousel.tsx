...
const features: FeatureType[] = [
  {
    ...
    description:
      "Creating responsive and scalable web applications for a seamless user experience.",
  },
  {
    id: 2,
    Icon: FiShield,
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "Designing intuitive and engaging user interfaces for your digital products.",
  },
  {
    id: 4,
    Icon: FiPhone,
    ...
    description:
      "Developing custom hardware and firmware for IoT and other connected devices.",
  },
  {
    id: 5,
    Icon: FiBox,
    ...
    description:
      "Leveraging cloud platforms to build scalable and resilient infrastructure.",
  },
];
