  ...
  return (
    <div className="col-span-1 h-[600px] lg:col-span-4 lg:h-[600px]">
      <Card>
        ...
        <CalloutChip>Our Process</CalloutChip>
        <p className="mb-2 text-2xl">Custom Solutions</p>
        <p className="mb-8 text-zinc-400">
          We work closely with you to understand your needs and deliver tailored
          software and hardware solutions that drive results.
        </p>
